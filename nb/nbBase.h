...
#if defined(_OS_WIN)
#define nbCALL      __cdecl //__stdcall                 //  Соглашение о вызовах функции:
...
//  5.Соглашение об условной трансляции не применяется;
  #if defined (_MICROSOFT_SPECIFIC_)
  #define nbNOVTABLE  __declspec(novtable)      //  Исключение виртуальной таблицы для интерфейсов
  #else
  #define nbNOVTABLE
  #endif
#else
